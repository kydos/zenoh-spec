...
Locators follow the format `protocol/address:port`, for example:
...
Protocol tokens are case-insensitive.  The address portion may be an IPv4 address, an IPv6 address in brackets, or a hostname.
